...
description: Demo-content uit de docs-template — markdown rendering coverage.
icon: lucide:rocket
scope: self
nav: [installation, usage]
---

> Deze sectie (`1.getting-started/`, `2.essentials/`, `3.ai/`) bevat de oorspronkelijke demo-content van de docs-template en blijft als regression-testbed voor markdown features (callouts, code blocks, prose, MDC). Echte 1000x-content komt onder modules zoals `4.lab/`, `6.syntax/` en `7.kb/`.

Onderstaand de originele template-introductie zoals hij in de docs-template stond:
