...
Eén bron voor alle navigatie-surfaces — sidebar, header-dropdowns (feature 7), prev/next (feature 5), tab-bewuste smart ToC (feature 6), levels-collapse (feature 8), én de **breadcrumb** bovenaan de pagina-content (sectie / hoofdstuk / pagina). Geen `.navigation.yml`-bestanden, geen hardcoded arrays in components.
