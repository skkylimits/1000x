...
| 08 | [08-smart-toc](./02-template/08-smart-toc/SPEC.md) | Smart ToC (scroll-driven, auto-fit) als panel-view; tab/level-awareness komt automatisch via routing |
| 09 | [09-changelog](./02-template/09-changelog/SPEC.md) | Commit-timeline van git onder de pagina-content |
| 10 | [10-prev-next](./02-template/10-prev-next/SPEC.md) | Scope-bound prev/next-kaarten onderaan iedere pagina (variant/level-awareness komt automatisch via URL-nesting) |
| 11 | [11-search](./02-template/11-search/SPEC.md) | `Cmd+K` command palette + scope-toggle ("huidige sectie" / "alles") |
