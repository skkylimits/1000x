...
Een knop in de header (zie Header, customization 03 in 02-template) opent een chat-panel dat over de content heen klapt, met de huidige pagina als context. Antwoorden streamen real-time via een server-route. Voor lezers die de docs als kennis-assistent willen gebruiken en pagina-specifieke vragen willen stellen.
...
- Op mobiel beslaat het panel volgens de mobiele layout een groter deel van het scherm (zie Mobiele layout, feature 07 in 03-features)
...
- Latere fase: generatie-acties (_Genereer PowerPoint_, _Genereer documentatie_) vanuit de pagina-actiebalk-dropdown (zie Page chrome, customization 06 in 02-template), die dezelfde AI-laag gebruiken
