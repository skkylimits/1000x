...
- `TDD/template/02-sidebar-replacement/SPEC.md` — this customization in detail. Read **§ Implementation Steps → Step 1** for the precise scope of this task, and **§ Constraints** for what stays out
- `TDD/features/02-section-sidebar/SPEC.md` — the parent feature (sidebar as nav-data source) that this customization replaces in the template
...
- Anything in **§ Constraints** of `TDD/template/02-sidebar-replacement/SPEC.md`

## Prerequisites — what you can assume

The Nuxt 4 project is scaffolded per `TDD/SCAFFOLDING.md`. The current branch is `01-template`. Relevant existing state:
