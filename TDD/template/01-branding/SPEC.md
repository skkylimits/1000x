...
- Logo-spacing in de header (zie Header met dropdown-menu's, feature 3) volgt de definitieve 1000x-richtlijnen voor whitespace en uitlijning
...
- Theme-color in het Web App Manifest (zie PWA en offline-werking, feature 17) is afgestemd op de 1000x-rood-tint
...
- Bij i18n-wissel (zie Internationalisatie, feature 4) blijft de branding identiek; geen taal-specifieke logo's of kleuren in de eerste release
