...
- Tab-bewust: bij content-tabs (zie Markdown rendering & content-engine, feature 1, en Content tabs, customization 06) reflecteert de ToC alleen de koppen van de actief geselecteerde tab; switchen van tab herrendert de ToC
...
- De customization bouwt op het rechter-panel-skelet uit Page chrome (customization 05) en op de content-tabs uit Content tabs (customization 06)
