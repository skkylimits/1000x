...
- [`03-content-stubs/`](./03-content-stubs/SPEC.md) — minimaal maar realistisch demo-tree onder `content/` dat alle render-paden uit stage 2 dekt (scope-modes, sectie-variants, content-tabs, standalone topics, kb-fallback)
