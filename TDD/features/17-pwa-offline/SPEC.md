...
- Drafts (zie View / Edit-toggle met lokale drafts, feature 10), lokale tree-mutaties (zie In-app content management, feature 11) en code-execution (zie Code-editor met browser-based execution, feature 13) blijven offline werken
...
- Code-execution (zie Code-editor met browser-based execution, feature 13) blijft offline werken zodra de WASM-runtime in de cache zit
- De search (zie Search, feature 9) heeft in latere iteraties een offline-mode-strategie; de eerste release maakt geen sterke offline-search-belofte
